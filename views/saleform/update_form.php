...
<?php $form = ActiveForm::begin(['id' => 'dynamic-form']); ?>
    ...
    <div class="table table-bordered">
                ...
                <div class="item1 panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="padding:0 1em 0 1em;">
                            ...
                            <div class="col-sm-3">
                                <?= $form->field($modelAddressf, "[{$j}]received_date",['inputOptions'=>['class'=>'form-control dynamic-date']]) ?>
                            </div>
                        </div><!-- .row -->
                    </div>
                </div>
        ...
        <tr>
            ...
            <?= $form->field($model, 'lat')->hiddenInput(['maxlength' => true,'id'=>'lat'])->label(false) ?>
            <?= $form->field($model, 'lng')->hiddenInput(['maxlength' => true,'id'=>'lng'])->label(false) ?>
